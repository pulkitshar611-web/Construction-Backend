...
const DEFAULT_PERMISSIONS = {
    'PM': ['VIEW_DASHBOARD', 'VIEW_PROJECTS', 'VIEW_SCHEDULE', 'VIEW_TASKS', 'VIEW_MY_TASKS', 'VIEW_DRAWINGS', 'VIEW_PHOTOS', 'VIEW_DAILY_LOGS', 'VIEW_ISSUES', 'VIEW_CHAT', 'VIEW_REPORTS', 'ACCESS_SETTINGS', 'CLOCK_IN_CREW', 'VIEW_RFI'],
    'FOREMAN': ['VIEW_DASHBOARD', 'VIEW_PROJECTS', 'VIEW_SCHEDULE', 'VIEW_TASKS', 'VIEW_MY_TASKS', 'CLOCK_IN_OUT', 'VIEW_DRAWINGS', 'VIEW_PHOTOS', 'VIEW_DAILY_LOGS', 'VIEW_ISSUES', 'VIEW_CHAT', 'CLOCK_IN_CREW', 'VIEW_RFI'],
    'WORKER': ['VIEW_DASHBOARD', 'VIEW_MY_TASKS', 'CLOCK_IN_OUT', 'VIEW_DRAWINGS', 'VIEW_PHOTOS', 'VIEW_CHAT'],
    'ENGINEER': ['VIEW_DASHBOARD', 'VIEW_PROJECTS', 'VIEW_DRAWINGS', 'VIEW_PHOTOS', 'VIEW_CHAT'],
    'CLIENT': ['VIEW_DASHBOARD', 'VIEW_PROJECTS', 'VIEW_DRAWINGS', 'VIEW_PHOTOS', 'VIEW_CHAT'],
    'SUBCONTRACTOR': ['VIEW_DASHBOARD', 'VIEW_PROJECTS', 'VIEW_SCHEDULE', 'VIEW_MY_TASKS', 'CLOCK_IN_OUT', 'VIEW_DRAWINGS', 'VIEW_PHOTOS', 'VIEW_DAILY_LOGS', 'VIEW_ISSUES', 'VIEW_CHAT', 'VIEW_EQUIPMENT', 'VIEW_TIMESHEETS', 'VIEW_RFI']
};
